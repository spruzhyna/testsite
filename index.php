...
<p>
    ...
    Black Goose Catering can handle events from snacks for a meetup to elegant corporate fundraisers.
</p>
...
<button onclick="windowAlert()">Click Me!</button>
 <div class="slideshow-container">
    <div class="mySlides fade">
        ...
        <img src="https://th.bing.com/th/id/R.82489b1bccde641cc486589e50afc262?rik=lGFkRHQJSvow4g&pid=ImgRaw&r=0" style="width:100%">
        <div class="text">Black Burger</div>
    </div>
     <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="https://th.bing.com/th/id/R.2ed492069f4b9730bcc4fe9e071bf807?rik=hY0ey3jcdscaqg&riu=http%3a%2f%2f4.bp.blogspot.com%2f_IwNN_x0zK2k%2fTA-BZ-5nGPI%2fAAAAAAAAAAU%2f04l2C0XsMEU%2fs1600%2fKrabbyPatty.jpg&ehk=5vCyrdB6VleOS0pagvgMkKxN73qHyeIPycs42npijAo%3d&risl=&pid=ImgRaw&r=0" style="width:100%">
        <div class="text">Crab's burger</div>
     </div>
    <div class="mySlides fade" >
        <div class="numbertext">3 / 3</div>
        <img src="https://th.bing.com/th/id/OIP.WbjMfkcT4bh-2rXX5XqVkgHaKq?pid=ImgDet&rs=1" style="width:100%">
